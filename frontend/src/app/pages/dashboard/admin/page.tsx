            ...
            <div className="col-span-12 lg:col-span-4 flex flex-col gap-4">
              <div className="bg-[var(--dashboard-card-bg)] rounded-3xl p-5 shadow-[0_10px_40px_rgba(0,0,0,0.03)] border border-[var(--dashboard-border)] transition-colors duration-300">
                ...
                <p className="mt-3 text-[var(--dashboard-text-secondary)] text-[10px] leading-relaxed font-medium">
                  Server load is currently at 12%. Database latency is under
                  5ms. No active incidents.
                </p>
              </div>
              ...
              <div className="bg-[var(--dashboard-card-bg)] rounded-3xl min-h-[400px] h-full relative overflow-hidden border border-[var(--dashboard-sidebar-border)] shadow-[0_10px_40px_rgba(0,0,0,0.03)] flex flex-col p-6 transition-colors duration-300">
                ...
                <div className="grid grid-cols-2 gap-4 flex-1">
                  {[
                    ...
                    {
                      label: "Active Scans",
                      val: isLoading ? "..." : stats?.totalScans || 0,
                      icon: "biotech",
                      color: "text-emerald-500",
                    },
                    {
                      label: "Acne Solutions",
                      val: isLoading ? "..." : stats?.totalSolutions || 0,
                      icon: "medical_services",
                      color: "text-amber-500",
                    },
                    {
                      label: "Active Habits",
                      val: isLoading ? "..." : stats?.totalHabits || 0,
                      icon: "calendar_month",
                    ...
                    <div
                      key={stat.label}
                      className="bg-[var(--dashboard-bg)] rounded-2xl p-4 flex flex-col justify-between hover:shadow-md transition-shadow"
                    >
                      <div
                        className={`w-10 h-10 rounded-full bg-[var(--dashboard-card-bg)] shadow-sm flex items-center justify-center ${stat.color}`}
                      >
                      ...
                      <div className="mt-4">
                        ...
                        <div className="text-2xl font-black text-[var(--dashboard-text)] mt-1">
                          {stat.val}
                        </div>
                      </div>
                    </div>
