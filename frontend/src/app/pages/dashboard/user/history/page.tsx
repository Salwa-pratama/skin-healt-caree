      ...
      onConfirm: async () => {
        ...
        try {
          ...
          setModalConfig({
            ...
            message:
              "Riwayat pemindaian telah berhasil dihapus secara permanen.",
            type: "success",
          });
        } catch (err) {
          ...
          setModalConfig({
            ...
            message:
              "Maaf, terjadi kesalahan saat mencoba menghapus riwayat pemindaian.",
            type: "error",
          });
        }
      },
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 md:mb-12">
          ...
          <p className="mt-4 text-[var(--dashboard-text-secondary)] max-w-2xl leading-relaxed text-sm md:text-base">
            Kelola dan tinjau hasil analisis dermatologi 3D Anda secara mendalam
            dengan akurasi klinis tinggi.
          </p>
        </div>
        ...
        {isError && (
          <div className="p-8 text-center bg-red-500/10 border border-red-500/20 text-red-500 rounded-3xl mb-8">
            ...
            <p className="text-sm opacity-80 mt-1">
              Pastikan server backend Anda sedang berjalan.
            </p>
          </div>
        )}
              ...
              filteredHistory.map((scan: any) => (
                ...
                >
                  <div>
                    ...
                    {scan.predictions &&
                      Array.isArray(scan.predictions) &&
                      scan.predictions.length > 0 && (
                  ...
                  <div className="mt-8 pt-6 border-t border-[var(--dashboard-border)] flex items-center justify-between">
                    <Link
                      href={`/pages/dashboard/user/history/${scan.id}`}
              ...
              {modalConfig.type === "confirm" ? (
                ...
                <button
                  ...
                  className={`w-full py-4 rounded-2xl font-black text-sm tracking-widest uppercase transition-all active:scale-95 ${
                    modalConfig.type === "success"
                      ? "bg-primary text-white shadow-lg shadow-primary/20 hover:bg-[#1c6d00]"
                      : modalConfig.type === "error"
