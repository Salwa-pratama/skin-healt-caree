  ...
  return (
    ...
    >
      ...
      <main className="flex-grow flex flex-col lg:flex-row overflow-hidden">
        {/* Left: Login Form */}
        <section className="login-form-panel w-full lg:w-1/2 flex items-center justify-center p-6 md:p-12 lg:p-16 relative overflow-hidden">
          ...
          <div className="w-full max-w-sm relative z-10 flex flex-col justify-center h-full">
            <div className="mb-6 sm:mb-8">
              <div className="flex items-center gap-2 mb-4">
                <span className="text-xl font-black tracking-tighter login-text-secondary">
                  DermaScan
                </span>
              </div>
            ...
            <form className="space-y-4" onSubmit={handleLogin}>
              <div className="space-y-1.5">
                <label className="block text-[9px] font-black uppercase tracking-widest login-text-muted ml-1">
                  Alamat Email
                </label>
                <div className="login-input-focus-accent transition-all">
                  <input
                    className="login-input w-full border-none rounded-xl py-3 px-4 text-sm focus:ring-0 focus:outline-none font-body"
              ...
              <div className="space-y-1.5">
                <div className="flex justify-between items-center px-1">
                  <label className="block text-[9px] font-black uppercase tracking-widest login-text-muted">
                    Kata Sandi
                  </label>
                  <Link
                    className="text-[9px] font-bold login-text-secondary hover:underline uppercase tracking-widest"
                    href="#"
                  >
                    Lupa?
                  </Link>
                ...
                <div className="login-input-focus-accent transition-all relative">
                  <input
                    className="login-input w-full border-none rounded-xl py-3 px-4 pr-11 text-sm focus:ring-0 focus:outline-none font-body"
                    placeholder="••••••••"
                  ...
                  <button
                    ...
                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-slate-400 hover:login-text-secondary transition-colors focus:outline-none"
                  >
              ...
              <div className="flex items-center gap-2.5 px-1">
                ...
                <label
                  className="text-xs font-semibold login-text-muted cursor-pointer"
                  htmlFor="remember"
                >
                  Ingat perangkat ini
                </label>
            ...
            <div className="mt-6">
              <div className="relative flex items-center justify-center mb-5">
                <div className="w-full h-px login-divider-line"></div>
                <span className="login-divider-bg absolute px-3 text-[9px] font-black uppercase tracking-widest login-text-muted-light">
                  atau
                </span>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <button className="login-social-btn flex items-center justify-center gap-2 py-2 rounded-xl font-bold text-[10px] uppercase tracking-widest">
                  <span className="material-symbols-outlined text-lg login-text-secondary">
                    medical_services
                  </span>{" "}
                  SSO
                </button>
            ...
            <div className="mt-6 flex items-center justify-center gap-4 text-xs font-medium login-text-muted">
              <span>Belum punya akun?</span>
              <Link
                className="login-text-secondary font-bold hover:underline"
        ...
        <section className="login-right-panel hidden lg:flex w-1/2 relative flex-col items-center justify-center overflow-hidden h-full">
          {/* Background Elements */}
          ...
          <div className="relative z-10 w-full max-w-xl px-6 flex flex-col gap-4 h-full justify-center">
            <div className="flex items-end justify-between px-1">
              <div>
                <h2 className="text-[9px] font-black uppercase tracking-[0.2em] login-text-muted-light mb-0.5">
                  Mode Diagnostik
                </h2>
                <p className="text-lg font-black login-text-primary">
                  Deteksi Jerawat AI{" "}
                  <span className="login-text-secondary font-medium text-sm">
                    v4.2
                  </span>
                </p>
              </div>
              <div className="flex items-center gap-1.5 login-glass-panel px-2.5 py-0.5 rounded-full border border-white/10 shadow-sm">
                <span className="w-1 h-1 rounded-full bg-[#84F75E] animate-pulse"></span>
                <span className="text-[8px] font-bold uppercase tracking-wider login-text-muted">
                  Neural Aktif
                </span>
              </div>
            </div>
            ...
            <div className="grid grid-cols-12 gap-3 h-auto max-h-[60%]">
              ...
              <div className="col-span-7 login-glass-panel rounded-2xl p-3 border border-white/10 shadow-xl shadow-black/[0.03] relative overflow-hidden flex flex-col">
                ...
                <div className="mt-3 flex justify-between items-center px-1">
                  <div>
                    <p className="text-[8px] font-bold login-text-muted uppercase tracking-wider">
                      Keyakinan
                    </p>
                    <p className="text-sm font-extrabold login-text-primary">
                      98.4%
                    </p>
                  </div>
              ...
              <div className="col-span-5 flex flex-col gap-3">
                <div className="login-glass-panel rounded-2xl p-3 border border-white/10 shadow-lg flex flex-col gap-3">
                  {[
                    ...
                    <div key={metric.label}>
                      <div className="flex justify-between items-end mb-1">
                        <span className="text-[8px] font-bold login-text-muted uppercase">
                          {metric.label}
                        </span>
                        <span className="text-[9px] font-extrabold login-text-primary">
                          {metric.val}%
                        </span>
                      </div>
                      <div className="h-1 w-full login-progress-bar rounded-full overflow-hidden">
                        <div
                ...
                <div className="flex-grow login-glass-panel rounded-2xl p-3 border border-white/10 shadow-lg flex flex-col">
                  <p className="text-[8px] font-bold login-text-muted uppercase mb-2 tracking-wider">
                    Regimen
                  </p>
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      ...
                      <p className="text-[8px] font-bold login-text-primary">
                        BHA Cleanser
                      </p>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <button className="mt-auto pt-3 w-full login-text-secondary text-[8px] font-black uppercase tracking-widest hover:underline text-left">
                    DETAIL LENGKAP
                  </button>
                </div>
              </div>
            ...
            {/* Bottom Summary */}
            <div className="login-glass-panel rounded-xl p-3 border border-white/10 shadow-lg flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] font-black login-text-primary">
                    Indeks Kesehatan Kulit
                  </p>
                  <p className="text-[8px] login-text-muted">
                    Intervensi klinis direkomendasikan.
                  </p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-xl font-black login-text-secondary leading-none">
                  64
                  <span className="text-[8px] font-bold login-text-muted ml-0.5">
                    /100
                  </span>
                </p>
              </div>
      ...
      {/* Thin Footer */}
      <footer className="login-footer w-full py-4 shrink-0">
        <div className="flex flex-col lg:flex-row justify-between items-center px-6 md:px-12 max-w-[1920px] mx-auto gap-4">
          <p className="text-[7px] font-black uppercase tracking-[0.15em] login-text-muted-light">
          ...
          <div className="flex gap-x-4">
            {["Privasi", "Ketentuan", "Kepatuhan Medis"].map((link) => (
              <Link
                key={link}
                className="text-[7px] uppercase tracking-[0.15em] font-black login-text-muted-light hover:login-text-secondary transition-colors"
                href="#"
              >
                {link}
              </Link>
        ...
        <div className="fixed top-[4.4rem] left-1/2 -translate-x-1/2 z-[200] w-full max-w-xs px-4">
          ...
          >
            ...
            <div className="flex-grow pr-4">
              <h3 className="text-[11px] font-black login-text-primary leading-tight">
                {modalType === "success" ? "Login Berhasil" : "Akses Ditolak"}
              </h3>
              <p className="login-text-muted text-[9px] leading-tight font-medium">
                {modalType === "success"
            ...
            {modalType === "success" && (
              <div className="absolute bottom-0 left-0 right-0 h-[2px] login-progress-bar">
                <div
