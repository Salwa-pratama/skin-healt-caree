            ...
            <form className="space-y-4" onSubmit={handleRegister}>
              ...
              <div className="flex items-center gap-2.5 px-1 py-1.5">
                ...
                <label
                  ...
                  htmlFor="terms"
                >
                  Saya setuju dengan Protokol Privasi & Ketentuan
                </label>
              </div>

              <button
                className="w-full bg-[#84F75E] text-[#0a3900] py-3.5 rounded-xl font-black text-base shadow-lg shadow-[#84F75E]/20 hover:shadow-[#84F75E]/30 hover:-translate-y-0.5 transition-all mt-3 disabled:opacity-70 disabled:cursor-wait"
                type="submit"
        ...
        <section className="hidden lg:flex w-1/2 bg-[#f0f4f2] relative flex-col items-center justify-center overflow-hidden border-l border-[#c1c9be]/30">
          ...
          <div className="relative z-10 w-full max-w-xl px-6 flex flex-col gap-5">
            <div className="flex items-end justify-between px-1">
              ...
              <div className="flex items-center gap-1.5 bg-white/60 backdrop-blur-sm px-2.5 py-1 rounded-full border border-white shadow-sm">
                <span className="w-1.5 h-1.5 rounded-full bg-[#84F75E] animate-pulse"></span>
                <span className="text-[9px] font-bold uppercase tracking-wider text-[#414941]">
                  Mesin Neural Aktif
                </span>
              </div>
            </div>
            ...
            {/* Bottom Summary Card */}
            <div className="register-glass-panel rounded-xl p-4 border border-white shadow-lg flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-[#84F75E] flex items-center justify-center shadow-md shadow-[#84F75E]/20">
                  <span className="material-symbols-outlined text-[#0a3900] text-xl">
                    clinical_notes
                  </span>
                </div>
                <div>
                  <p className="text-xs font-black text-[#1a1c1a]">
                    Indeks Kesehatan Keseluruhan
                  </p>
                  <p className="text-[10px] text-[#414941]">
                    Jerawat moderat terdeteksi. Disarankan regimen klinis.
                  </p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-2xl font-black text-[#386a20] leading-none">
                  64
                  <span className="text-[10px] font-bold text-[#414941] ml-1">
                    /100
                  </span>
                </p>
                <span className="text-[8px] font-bold bg-yellow-500/15 text-yellow-700 px-1.5 py-0.5 rounded-full uppercase tracking-tighter mt-1 inline-block">
                  Butuh Tinjauan
                </span>
              </div>
            </div>
      ...
      <footer className="w-full bg-[#f1f5f2] py-8 border-t border-[#c1c9be]/30">
        <div className="flex flex-col lg:flex-row justify-between items-center px-6 md:px-12 max-w-[1920px] mx-auto gap-6">
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-3 order-1 lg:order-2">
            <Link
              className="text-[8px] font-black uppercase tracking-[0.15em] text-[#414941] hover:text-[#386a20] transition-colors"
              href="#"
            >
              Protokol Privasi
            </Link>
